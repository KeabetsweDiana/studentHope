            ...
            <div class="container-fluid">
                <div class="row" id="top">
				   ...
				   <div class="row">
                    <div class="col-md-12">
                        <div>
                            <h1 align="center">All Individual Appointments</h1>
                            <div id="small-nav">
                                <ul id="inner-nav">
                ...
                <div class="table-responsive" id="sessions">
                    <table class="table">
						...
						<?php 
							$ret=mysqli_query($con,"select * from session WHERE sessionType ='INDIVIDUAL' AND stdNum != ".$_SESSION['stdNum']);
								$cnt=1;
							...
							<td><?php if($row['status'] =='PENDING')
										{
											...
											echo '<a href="acceptdInd.php?uid='.$row['sessionID'].'"><button class="btn btn-primary" id="accepted-btn" type="button">Accept</button></a>';
